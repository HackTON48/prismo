...
contract Pricing is Storage {
        ...
        returns (uint256 receiveQuoteToken)
    {
        ...
        uint256 Q2 = PRISMOMath._SolveQuadraticFunctionForTrade(
    ...
    {
        require(amount < targetBaseTokenAmount, "PRISMO_BASE_BALANCE_NOT_ENOUGH");
    ...
    function _RBelowBackToOne() internal view returns (uint256 payQuoteToken) {
        ...
        uint256 newTargetQuote = PRISMOMath._SolveQuadraticFunctionForTarget(
            _QUOTE_BALANCE_,
            _K_,
            fairAmount
        );
    ...
    function _RAboveBuyBaseToken(
        ...
        require(amount < baseBalance, "PRISMO_BASE_BALANCE_NOT_ENOUGH");
    ...
    function _RAboveBackToOne() internal view returns (uint256 payBaseToken) {
        ...
        uint256 newTargetBase = PRISMOMath._SolveQuadraticFunctionForTarget(
            _BASE_BALANCE_,
            _K_,
            fairAmount
        );
    ...
    function _RAboveIntegrate(
        ...
        uint256 i = getOraclePrice();
        return PRISMOMath._GeneralIntegrate(B0, B1, B2, i, _K_);
    }
    ...
    //     return PRISMOMath._GeneralIntegrate(Q0, Q1, Q2, i, _K_);
    // }
}
